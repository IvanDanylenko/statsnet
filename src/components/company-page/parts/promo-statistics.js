...
const PromoStatistics = () => {
  return (
    <div className="promo-statistics" itemScope itemType="http://schema.org/Organization">
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-9 col-md-8">
            <div className="tabs company-params-tabs js-company-info-tabs">
