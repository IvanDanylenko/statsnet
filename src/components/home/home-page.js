              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="advantages--item">
                    ...
                    <h3>Оценка рисков</h3>
                    <p>Уникальные аналитические показатели, позволяющие провести экспресс-анализ компании и оценить ее благонадежность</p>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="advantages--item">
                    ...
                    <p>Предоставляем отчеты и выписки из государственных реестров, судов, правоохранительных органов, кредитных бюро.</p>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="advantages--item">
